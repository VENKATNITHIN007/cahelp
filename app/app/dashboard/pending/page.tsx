...
//                       <div className="font-semibold text-lg truncate">{d.title}</div>
//                       <div className="text-sm text-gray-600 truncate">Client: {d.clientName ?? "—"}</div>
//                     </div>
...
//                       className="rounded border px-2 py-1 text-sm w-auto sm:w-auto min-w-[6rem]flx-shrink"
//                     >
...
//                       <td className="p-3 align-top max-w-xs min-w-0">
//                         <div className="truncate">{d.title}</div>
//                       </td>
//                       <td className="p-3 align-top max-w-xs min-w-0">
//                         <div className="text-sm text-gray-600 truncate">{d.clientName ?? "—"}</div>
//                       </td>
